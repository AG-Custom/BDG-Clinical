...
**Montagem:** `GET /api/units`, `GET /api/products`, `GET /api/stock-movements` (query opcional `transferenciaEstoqueId`).
...
**Montagem:** `GET /api/units`, `GET /api/products`, `GET /api/stock-balances` (saldo da origem).
