...
namespace AG.CLINICAL.Infra.Data.Configurations.Audits;
...
internal sealed class LogAuditoriaConfiguration : IEntityTypeConfiguration<LogAuditoria>
{
    public void Configure(EntityTypeBuilder<LogAuditoria> builder)
    {
        ...
        builder.Property(entity => entity.DadosAnteriores).HasColumnType("nvarchar(max)");
        builder.Property(entity => entity.DadosNovos).HasColumnType("nvarchar(max)");
