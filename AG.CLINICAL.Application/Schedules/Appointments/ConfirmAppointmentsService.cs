...
public interface IConfirmAppointmentsService
{
...
public sealed class ConfirmAppointmentsService : IConfirmAppointmentsService
{
    ...
    public ConfirmAppointmentsService(
