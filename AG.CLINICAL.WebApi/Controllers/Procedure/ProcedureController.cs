...
namespace AG.CLINICAL.WebApi.Controllers.Procedure;
...
public sealed class ProcedureController : ControllerBase
{
    ...
    [HttpGet]
    [RequireAnyPermissionFrom(AuxiliaryPermissionSet.Procedures)]
    ...
    [HttpPost]
    [RequirePermission("procedimento.criar")]
    ...
    [HttpPut("{id:guid}")]
    [RequirePermission("procedimento.editar")]
