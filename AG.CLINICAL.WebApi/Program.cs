...
using AG.CLINICAL.WebApi.Extensions;
using AG.CLINICAL.WebApi.Extensions.Auth;
using AG.CLINICAL.WebApi.Extensions.Common;
...
{
    options.SwaggerEndpoint("/swagger/v1/swagger.json", "AG Clinical API v1");
